...
<div class="flex bg-white w-full rounded-xl py-6 px-8 justify-between items-center">
    <div class="flex flex-col gap-3.5 max-w-[80%]">
        ...
        <p>{{ $detail }}</p>
            <a href="{{ $button['linkTo'] }}" class="rounded-full bg-dawn font-bold px-6.5 py-3 w-fit cursor-pointer hover:bg-midnight hover:text-white hover:scale-102 transition-all duration-300"> {{ $button['name'] }} </a>
    </div>
