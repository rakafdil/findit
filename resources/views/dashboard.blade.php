<x-layout.layout class="relative bg-white px-18 py-9.5 z-0 overflow-clip">
    ...
    <img src="{{ asset("assets/dashboard/lock-dynamic-gradient.png") }}" class="bg-image absolute -z-1 top-10 right-100">
    <img src="{{ asset("assets/dashboard/clock-dynamic-gradient.png") }}" class="bg-image absolute -z-1 top-80 -right-10">
    <img src="{{ asset("assets/dashboard/headphone-dynamic-gradient.png") }}" class="bg-image absolute -z-1 bottom-80 -left-30">
    <img src="{{ asset("assets/dashboard/chat-text-dynamic-gradient.png") }}" class="bg-image absolute -z-1 -bottom-10 left-120">
</x-layout.layout>